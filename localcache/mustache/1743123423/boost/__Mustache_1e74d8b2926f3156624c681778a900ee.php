...
class __Mustache_1e74d8b2926f3156624c681778a900ee extends Mustache_Template
{
...
';
                ...
                if (is_callable($blockFunction)) {
                    ...
                    $buffer .= $indent . '                                    <div
';
                    $buffer .= $indent . '                                        class="post-actions d-flex align-self-end justify-content-end flex-wrap ms-auto"
';
