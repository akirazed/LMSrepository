...
class __Mustache_dfb735f9ec9183081aee3647bad0c111 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC06dd311be650d8e2dae611810784211($context, $indent, $value);
        $buffer .= $indent . '</div>
';
...
';
    ...
    private function sectionC06dd311be650d8e2dae611810784211(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('name'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '[]" class="custom-select mb-1">
';
