...
class __Mustache_91320d30103b0ea50062b6361a5bb51c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template-inline')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block36a5d25d5cd8f3560c99bcabb14dc15c'),
            ));
...
';
    ...
    public function block36a5d25d5cd8f3560c99bcabb14dc15c($context)
    {
        $indent = $buffer = '';
        $buffer .= $indent . '    <div class="d-flex ms-1">
';
