...
class __Mustache_9deed38059398e570e5a91ad7ed189a1 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCeeda159c93fa58f41c9309f0d3c500b($context, $indent, $value);
        $value = $context->find('settingsurl');
        $buffer .= $this->section378bd95d8581bcfe63563cc44421a509($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function sectionCeeda159c93fa58f41c9309f0d3c500b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section378bd95d8581bcfe63563cc44421a509(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
